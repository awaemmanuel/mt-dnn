...
def test_prepro():
    ...
    result = subprocess.check_output("python prepro_std.py --model_utils bert-base-uncased --root_dir run_test/sample_data/canonical_data --task_def experiments/glue/glue_task_def.yml --do_lower_case", stderr=subprocess.STDOUT, shell=True)
